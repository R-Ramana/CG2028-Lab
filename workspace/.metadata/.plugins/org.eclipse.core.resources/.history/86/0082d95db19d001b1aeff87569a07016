...
int main(void)
{
	...
	int b[N_MAX+1] = {100, 250, 360, 450, 580, 690, 710, 820, 900, 1030}; //N+1 dimensional feedforward
	int a[N_MAX+1] = {100, 120, 180, 230, 250, 340, 260, 130, 140, 80}; //N+1 dimensional feedback
